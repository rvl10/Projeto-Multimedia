...
$pdoConnection = require_once "ligacao_bd.php";
$categorias = getCategorias($pdoConnection);

// sub categorias

require_once "funcoes/adicionar_sub_categorias.php";
$adicionarSubCategoria = getSubCategorias($pdoConnection);
                            ...
                            <ul>
                                <ul>
                                    ...
                                    <li class="btn btn-primary">
                                        ...
                                        <a class="btn btn-primary" href="carrinho.php?acao=add&id=<?php echo $categoria['id']?>" class="card-link"></a>
							...
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										<div class="home_slider_title " style="color: black">Venha conhecer os novos Surface</div>
										<div class="home_slider_subtitle" style="color: brown"><h3>Já disponivel Microsoft Surface Pro 7 e Microsoft Surface Laptop 3.</h3></div>
							...
							<div class="row">
								<div class="col">
									<div class="home_slider_content"  data-animation-in="fadeIn" data-animation-out="animate-out fadeOut">
										...
										<div class="home_slider_subtitle"><h3>Câmaras Pro.</h3><p></p> <h3>Ecrã Pro.</h3><p></p><h3>Desempenho Pro.</h3><p></p> <h6>Desde 1179€</h6></div>
			...
			<div class="avds_large">
				...
				<div class="avds_large_container">
					<div class="avds_large_content">
						...
						<div class="avds_text">És um gamer, ou estas a começar a entrar no mundo dos Gamings, vem descobrir as novidades e torna-te um campeão</div>
				...
				<div class="col">
					<div class="avds_xl_container clearfix">
						...
						<div class="avds_xl_content">
							...
							<div class="avds_text">És um fã da apple? <p></p>Estas no sitio certo, nos apresentamos-te as ultimas novidades do mundo IOS</div>
