...
$nome_err = $assunto_err = $mensagem_err = $email_err = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["mensagem"]))) {
        $mensagem_err = "Por favor introduza a mensagem.";
    } else {
    ...
    if (empty(trim($_POST["email"]))) {
        $email_err = "Introduza a descrição.";
    } else {
    ...
    if (empty($nome_err) && empty($assunto_err) && empty($mensagem_err) && empty($email_err)) {

        // Prepare an insert statement
        $sql = "INSERT INTO duvidas (nome, assunto, mensagem, email) VALUES (?, ?,?,?)";

        if ($stmt = mysqli_prepare($link, $sql)) {
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "ssss", $param_nome, $param_assunto, $param_mensagem, $param_email);
            ...
            <div class="row">
                ...
                <div class="col-lg-8 contact_col">
                    <div class="get_in_touch">
                        <div class="section_title">Entra em Contato Conosco</div>
